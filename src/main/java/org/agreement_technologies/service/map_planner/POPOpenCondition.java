...
public class POPOpenCondition implements OpenCondition {
    ...
    public Condition getCondition()            	{return precEff.getCondition();}
    public POPPrecEff getPrecEff()  			{return precEff;}
    public POPStep getStep()                    {return step;}
    public void setStep(POPStep step)           {this.step = step;}
    ...
    public void setGoal()               {this.isGoal = true;}
    public void setNotGoal()            {this.isGoal = false;}
