...
public class POP extends Planner {
    ...
    public POP(PlannerFactoryImp conf, POPStep initial, POPStep last, 
        ...
        POPComparator pcmp;
        switch (searchType) {
		case PlannerFactory.SEARCH_SPEED:     pcmp = new POPComparatorASpeed(
                        this.configuration.getGroundedTask()); break;
		case PlannerFactory.SEARCH_BALANCED : pcmp = new POPComparatorABalanced(
                        this.configuration.getGroundedTask()); break;
		case PlannerFactory.SEARCH_LANDMARKS: pcmp = new POPComparatorALandmarks(
                        this.configuration.getGroundedTask()); break;
		default: pcmp = new POPComparatorAQuality(
                        this.configuration.getGroundedTask()); break;
		}
