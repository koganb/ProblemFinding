...
public abstract class Planner implements ExtendedPlanner {
		...
		while ((solution == null || isAnytime)
			...
			if (agentListener != null)
				this.agentListener.trace(1,
                        ...
                        else if (comm.batonAgent()) System.out.println("Hdtg = " + basePlan.getH() + ", Hlan = " + basePlan.getHLan());    
	 ...
	 *            Base plan
	 * @param father
	 *            Incremental definition of the base plan
	 */
	 ...
	 *            New causal link
	 * @param successor
	 *            Successor plan that stores the new causal link
	 */
	 ...
	 *            New step introduced
	 * @param index
	 *            Index of the step s2 of the ordering ns -> s2, where ns is the
	 *            new step introduced
	 * @param successor
	 *            Successor plan that stores the new step
	 */
