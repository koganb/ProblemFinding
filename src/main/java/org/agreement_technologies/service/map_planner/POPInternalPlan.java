...
public class POPInternalPlan implements Cloneable {
    ...
    public ExtendedPlanner getPlanner()                         {return POP;                                }
    public void setPreconditions(ArrayList<OpenCondition> p)    {this.openConditions = p;                   }
    public ArrayList<OpenCondition> getPreconditions()          {return this.openConditions;                }
    public ArrayList<POPThreat> getThreats()                    {return this.threats;                       }
    public POPInternalPlan getFather()                          {return this.father;                        }
    public POPOrdering getOrdering()                            {return this.ordering;                      }
    public POPStep getStep()                                    {return this.step;                          }
    public POPCausalLink getCausalLink()                        {return this.causalLink;                    }
    public void setOrdering(int v1, int v2)                     {this.ordering = new POPOrdering(v1, v2);   }
    public void setNumSteps(int n)                              {steps = n;                                 }

    public Step getFinalStep() {return POP.getFinalStep();}
