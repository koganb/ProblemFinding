...
public class POPAction {
    ...
    public ArrayList<POPPrecEff> getPrecs()     {return this.precs;}
    public ArrayList<POPPrecEff> getEffects()   {return this.effects;}
    //public int getMinTime()                     {return this.minTime;}
    public void setName(String name)            {this.actionName = name;}
    public String toString()                    {return this.actionName;}
	public Condition[] getPrecConditions()      { return precConds; }
	public Condition[] getEffConditions()       { return effConds; }
}
